...
export const translations = {
  fr: {
    ...
    dashStudioSubtitle: "Diffuse en direct depuis le navigateur (Cloudflare Stream WHIP) — sans OBS.",
  ...
  en: {
    ...
    dashStudioSubtitle: "Go live from your browser with Cloudflare Stream WHIP — no OBS required.",
