...
export const translations = {
  fr: {
    ...
    magicLinkNotice: "On t'enverra un lien magique pour te connecter en toute sécurité.",
    btnInstantConnect: "🚀 Connexion instantanée",
    btnSendMagicLink: "Envoyer le lien magique",
  ...
  en: {
    ...
    magicLinkNotice: "We'll send you a magic link to securely sign in.",
